...
public class Main {
	...
	static int[] answer_dirs = new int[11];
	public static void main(String[] args) throws IOException {
		...
		for(int i = 1; i<=answer; i++) {
			String dir_char = null;
			switch(answer_dirs[i]) {
				case 0:
					dir_char = "U";
					break;
				case 1:
	...
	static void slide(int[] blue, int[] red, int dir, int count, int[] dirs) {
